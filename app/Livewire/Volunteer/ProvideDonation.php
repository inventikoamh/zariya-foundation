...
class ProvideDonation extends Component
{
    ...
    {
        // Volunteers can only see donations that are assigned to them AND completed
        $this->donations = Donation::where('assigned_to', auth()->id())
    ...
    {
        return view('livewire.volunteer.provide-donation');
    }
}
