                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $totalDonations ?? '0' }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $pendingRequests ?? '0' }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">New donation received</p>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">New request submitted</p>
