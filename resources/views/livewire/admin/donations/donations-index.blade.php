            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model.live="search"
                           placeholder="Search by donor, item, service..."
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <div>
                        ...
                        <select wire:model.live="assignedToFilter" class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $donations->where('status', 'pending')->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $donations->where('status', 'completed')->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $donations->where('is_urgent', true)->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($donations as $donation)
                        <tr class="hover:bg-gray-50 {{ $donation->is_urgent ? 'bg-red-50' : '' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $donation->location }}</div>
                                @if($donation->pincode)
                                    <div class="text-sm text-gray-500">{{ $donation->pincode }}</div>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ \App\Services\StatusHelper::getStatusBadgeClass($donation->status, $donation->type) }}">
                                    {{ $donation->status_label }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $donation->priority === 1 ? 'bg-gray-100 text-gray-800' : '' }} {{ $donation->priority === 2 ? 'bg-yellow-100 text-yellow-800' : '' }} {{ $donation->priority === 3 ? 'bg-orange-100 text-orange-800' : '' }} {{ $donation->priority === 4 ? 'bg-red-100 text-red-800' : '' }}">
                                    {{ $donation->priority_label }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($donation->assignedTo)
                                    ...
                                    <div class="text-sm text-gray-500">{{ $donation->assignedTo->email }}</div>
                                @else
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 mb-4">Get started by creating your first donation.</p>
                                    <a href="{{ route('admin.donations.create') }}"
