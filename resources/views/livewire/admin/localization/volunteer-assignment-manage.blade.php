        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Assign volunteers to regions and manage their roles
                    </p>
                </div>
            ...
            <div class="mt-6 bg-white shadow rounded-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                        <label for="assignmentTypeFilter" class="block text-sm font-medium text-gray-700">Assignment Type</label>
                        <select
                            id="assignmentTypeFilter"
                            wire:model.live="assignmentTypeFilter"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        >
            ...
            <!-- Assignments Table -->
            @include('livewire.admin.localization.partials.assignments-table')
        </div>
    </div>

    <!-- Modal -->
    @include('livewire.admin.localization.partials.assignment-modal')
</div>
