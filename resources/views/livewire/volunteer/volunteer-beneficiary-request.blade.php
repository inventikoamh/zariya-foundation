                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select wire:model="country_id" id="country_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            <label for="state_id" class="block text-sm font-medium text-gray-700">State/Province *</label>
                            <select wire:model="state_id" id="state_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500" {{ empty($states) ? 'disabled' : '' }}>
                        ...
                        <div>
                            ...
                            <select wire:model="city_id" id="city_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500" {{ empty($cities) ? 'disabled' : '' }}>
                        ...
                        <div>
                            <label for="pincode" class="block text-sm font-medium text-gray-700">Postal Code</label>
                            <input type="text" wire:model="pincode" id="pincode" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500" placeholder="12345">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            ...
                            <li>Please provide accurate information to help us process your request faster</li>
